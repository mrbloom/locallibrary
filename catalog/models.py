...
class Book(models.Model):
    ...
    c = models.TextField(max_length=1000, help_text="Enter a brief description of the book")
...
class BookInstance(models.Model):
    ...
    def display_book(self):
        return self.book.author.last_name + " " + self.book.title #". ".join([bk.title for bk in self.book.all()[:1]])

    display_book.short_description = 'Книга'
